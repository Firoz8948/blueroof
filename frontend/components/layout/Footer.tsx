 ...
 * Includes company info, links, and contact information
 */
      ...
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-2 gap-8 md:contents">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>{footerLinks.contact[0].value}</li>
                <li>
                  <a
                    href={`mailto:${footerLinks.contact[1].value}`}
                    className="hover:text-blue-400 transition-colors"
                  >
                    {footerLinks.contact[1].value}
                  </a>
                </li>
                <li className="text-sm">{footerLinks.contact[2].value}</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} BlueRoof Realty. All rights reserved.
          </p>
